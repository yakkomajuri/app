...
describe('issue_comment event', () => {
    ...
    test('Happy path, add correct new contributor', async () => {
        const mock = nock('https://api.github.com')
            .get(`/repos/all-contributors/all-contributors-bot/git/ref/heads%2Fall-contributors%2Fadd-jakebolam`)
            .reply(404)
            ...
            .put(`/repos/all-contributors/all-contributors-bot/contents/.all-contributorsrc`, (body) => {
                expect(body).toMatchSnapshot('request body')
                return true
            })
            .reply(200, reposUpdateFiledata)

            .put(`/repos/all-contributors/all-contributors-bot/contents/README.md`, (body) => {
                expect(body).toMatchSnapshot('request body')
                return true
            })
            .reply(200, reposUpdateFiledata)
            ...
            .post('/repos/all-contributors/all-contributors-bot/issues/1/comments', (body) => {
                expect(body).toMatchSnapshot('request body')
                return true
            })
            .reply(200)
    ...
    test('Happy path, add correct new contributor, but branch exists', async () => {
        const mock = nock('https://api.github.com')
            ...
            .get('/repos/all-contributors/all-contributors-bot/contents/.all-contributorsrc')
